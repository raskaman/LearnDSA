...
where T : IComparable
{
    ...
    public void Add(T data)
    {
        ...
        if (parent == null)
        {
            Root = node; // as parent is null, there are no nodes in the tree, make the node the root
        }
        ...
        else
        {
            ...
            else
            {
                BinaryTreeNode<T> successor =
                    FindMinimunInSubtree(node.Right);
    ...
    private BinaryTreeNode<T> FindMinimunInSubtree(BinaryTreeNode<T> node)
    {
